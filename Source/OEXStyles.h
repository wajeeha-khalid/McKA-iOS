...
@property (class, nonatomic) OEXStyles *sharedStyles;
...
- (UIFont*)semiBoldRaleWayOfSize:(CGFloat)size;//Added by Ravi on 17 Jan'17 to set custom font for sections
...
- (UIColor*)piqueGreenColor; // Added By Ravi on 17 Jan'17 to set color
