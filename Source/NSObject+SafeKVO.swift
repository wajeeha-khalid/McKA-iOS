...
extension NSObjectExtensions where Self : NSObject {
    ...
    @discardableResult func oex_addObserver<Observer : NSObject>(_ observer : Observer, forKeyPath keyPath: String, action: @escaping (Observer, Self, AnyObject) -> Void) -> Removable {
