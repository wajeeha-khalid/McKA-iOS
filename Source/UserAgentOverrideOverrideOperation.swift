...
class UserAgentGenerationOperation : edXCore.Operation {
...
class UserAgentOverrideOperation : edXCore.Operation {
    ...
    @objc static func overrideUserAgent(_ completion : (() -> Void)? = nil) {
...
extension UserAgentGenerationOperation {
    var t_resultStream : edXCore.Stream<String> {
        return resultStream
    }
}
