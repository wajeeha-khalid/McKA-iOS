...
open class KeyboardInsetsSource : NSObject, ContentInsetsSource {
    open weak var insetsDelegate : ContentInsetsSourceDelegate?
    open let affectsScrollIndicators = true
    ...
    public init(scrollView : UIScrollView) {
        ...
        NotificationCenter.default.oex_addObserver(self, name: NSNotification.Name.UIKeyboardDidChangeFrame.rawValue) { (notification, observer, _) -> Void in
