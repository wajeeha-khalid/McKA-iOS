...
extension UIAlertController {
    static func actionSheetWithItems<A : Equatable>(_ items : [(title : String, value : A)], currentSelection : A? = nil, action : @escaping (A) -> Void) -> UIAlertController {
...
extension UIAlertController {
    func addCancelAction(_ handler : @escaping (UIAlertAction) -> Void = {_ in }) {
