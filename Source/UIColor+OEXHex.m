...
+ (UIColor *) piqueGreen{
    return [UIColor colorWithRed:0.0/255.0 green:255.0/255.0 blue:204.0/255.0 alpha:1.0f];
}

+ (UIColor *) piqueMediumGray{
    return [UIColor colorWithRed:119.0/255.0 green:121.0/255.0 blue:123.0/255.0 alpha:1.0f];
}
