...
#define FTUE @"showCourseware"
//Screen Names
#define APP_DELEGATE    ((OEXAppDelegate *)[[UIApplication sharedApplication] delegate])
#define APP_SETTINGS     @"App Settings"
#define ACCOUNT_SETTINGS @"My Account Settings"
#define Recent Media     @"Recent Media"

//First time user check
#define FIRST_TIME_USER_KEY @ "signedIn"
...
//Audios
#define CAV_KEY_AUDIOS @"audios"
#define CAV_KEY_RECENT_AUDIOS @"sortedAudios"
#define CAV_KEY_AUDIOS_SIZE @"audioSize"


//Download complete notification
#define VIDEO_DL_COMPLETE_N_TASK @"video_Download_otification_task"
#define AUDIO_DL_COMPLETE_N_TASK @"audio_Download_otification_task"
...
//Local Saving complete notification
#define kLocalSavingNotification @"DataSavedLocally"
...
//VR Video Identifier
#define VR_VIDEO_IDENTIFIER @"_360_"
