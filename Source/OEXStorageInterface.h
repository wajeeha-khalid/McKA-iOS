...
#pragma - Audio Podcast Download


// Get a Audio data for passed audioID
...
// Set the download state to NEW for a audio and delete the entry form the sandbox.
- (void)deleteDataForAudioURL:(NSString*)audioURL;
