...
//Added by Ravi on 17 Jan'17 to set color for sections
- (UIColor*)piqueGreenColor
{
   return [self.oexColors colorForIdentifier:ColorsIdentifiersPiqueGreen ];
}
...
//Added by Ravi on 17 Jan'17 to set custom font for sections
- (UIFont*)semiBoldRaleWayOfSize:(CGFloat)size
{
    return [UIFont fontWithName:@"Raleway-SemiBold" size:size]; //Raleway-SemiBold
}

- (UIFont*)raleWayOfSize:(CGFloat)size
{
	return [UIFont fontWithName:@"Raleway-Regular" size:size];
}
