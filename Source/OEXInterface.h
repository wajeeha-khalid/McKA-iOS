...
#import "OEXHelperOfflineTracker.h"
#import "OEXHelperUnitCompletionTracker.h"

NS_ASSUME_NONNULL_BEGIN

@class OEXHelperVideoDownload;
@class OEXUserDetails;
@class OEXHelperAudioDownload;
...
@property (nullable, nonatomic, strong) NSMutableDictionary* courseAudios; ////Added By Ravi on 22Jan'17 to Implement AudioPodcast
@property (nullable, nonatomic, strong) NSMutableDictionary* courseAudiosDic; ////Added By Ravi on 22Jan'17 to Implement AudioPodcast
...
+ (nullable NSString*)getCCSelectedLanguage;
...
// Added by Ravi on 27Jan'17
#pragma mark Audio Management
- (nullable NSString*)stateForAudioId:(nullable NSString*)audioId;
- (OEXHelperAudioDownload* _Nullable)stateForAudioWithID:(nullable NSString*)audioID;
- (NSInteger)downloadAudiosWithIDs:(NSArray*)audioIDs;/// @param array An array of Audio ids representing the audios to download
...
- (NSArray*)coursesAndAudiosForDownloadState:(OEXDownloadState)state;
...
//- (void)downloadAllTranscriptsForAudio:(OEXHelperAudioDownload*)videoDownloadHelper;
...
- (NSArray<OEXHelperAudioDownload*>*)allAudiosForState:(OEXDownloadState)state;
