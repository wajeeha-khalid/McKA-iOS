...
/// Are the fullscreen buttons hidden
@property (assign, nonatomic) BOOL hidesFullSceenButton;
...
@property (nonatomic, strong) UIView* activityBackgroundView; //Added By Ravi to set background for AudioPodcats
