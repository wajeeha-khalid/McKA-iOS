...
extension OEXTextStyle {
    ...
    func apply(_ f : @escaping (String) -> String) -> ((NSAttributedString) -> NSAttributedString) {
    ...
    @nonobjc
    func apply(_ f : @escaping (String, String) -> String) -> ((NSAttributedString, NSAttributedString) -> NSAttributedString) {
...
extension String {
    func applyStyle(_ style : OEXTextStyle) -> NSAttributedString {
