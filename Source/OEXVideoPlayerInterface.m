...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    // Commented by Ravi on 9Mar'17 for video and audio playing even after view is disappread.
...
//    }
    ...
    [_moviePlayerController stop]; //Added by Ravi  on 9Mar'17 for video and audio playing even after view is disappread.
    _shouldRotate = NO;
}
