...
- (void)trackSingleAudioDownload:(NSString*)audioID
                        CourseID:(NSString*)courseId
                         UnitURL:(nullable NSString*)unitUrl; // Added By Ravi on 31Jan'17 for Audio Podcast Download

- (void)trackAudioDownloadComplete:(NSString*)audioId
                          CourseID:(NSString*)courseId
                           UnitURL:(NSString*)unitUrl;// Added By Ravi on 31Jan'17 for Audio Podcast Download
