...
@protocol OEXAudioPlayerInterfaceDelegate <NSObject>
...
@interface OEXAudioPlayerInterface : UIViewController <CLVideoPlayerControllerDelegate>


@property(nonatomic, weak, nullable) id <OEXAudioPlayerInterfaceDelegate>  delegate;
// Allows setting the controller's view. This is deprecated, the controller should be responsible for its own view
@property (nonatomic, weak, nullable) UIView* audioPlayerVideoView;
@property (nonatomic, strong, nullable) CLVideoPlayer* moviePlayerController;
@property(nonatomic) BOOL shouldRotate;
@property(nonatomic, strong) NSString* reqAudioString;
