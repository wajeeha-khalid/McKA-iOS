...
class UserProfileManagerTests : XCTestCase {
    ...
    func testCurrentUserSwapsFeed() {
        ...
        var expectation = self.expectation(description: "Profile populated")
        feed.refresh()
        ...
        expectation = self.expectation(description: "Profile removed")
        ...
        expectation = self.expectation(description: "Profile populated again")
        feed.refresh()
    ...
    func testUpdate() {
        ...
        expectation = self.expectation(description: "Profile updated")
        ...
        expectation = self.expectation(description: "Profile feed update")
        profileFeed.output.listenOnce(self) {
